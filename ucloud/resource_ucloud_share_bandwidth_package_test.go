		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ucloud_share_bandwidth_package.foo", "share_bandwidth", "20"),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckShareBandwidthPackageExists("ucloud_share_bandwidth_package.foo", &sbpSet),
					testAccCheckShareBandwidthPackageAttributes(&sbpSet),
					resource.TestCheckResourceAttr("ucloud_share_bandwidth_package.foo", "share_bandwidth", "25"),
				),
			},
		},
	})
